...
<head>
	...
	<!-- CSS -->
	<link rel="stylesheet" href="{{ URL::asset('components/bootstrap.css') }}">
	<link rel="stylesheet" href="{{ URL::asset('components/angular-gridster.min.css') }}">
	<link rel="stylesheet" href="{{ URL::asset('components/angular-social.css') }}">
	<link rel="stylesheet" href="{{ URL::asset('components/owl.carousel.css') }}">
	<link rel="stylesheet" href="{{ URL::asset('components/owl.theme.css') }}">
